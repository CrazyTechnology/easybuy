var Layout = function () {
    var e = "layouts/layout4/img/", a = "layouts/layout4/css/", s = App.getResponsiveBreakpoint("md"), i = function () {
        ...
        if (t.hasClass("page-footer-fixed") === !0 && t.hasClass("page-sidebar-fixed") === !1) {
            ...
            if (t.hasClass("page-sidebar-fixed"))e = n() - 10, t.hasClass("page-footer-fixed") === !1 && (e -= $(".page-footer").outerHeight(!0)); else {
                var r = $(".page-header").outerHeight(!0), p = $(".page-footer").outerHeight(!0);
        ...
        var i = location.hash.toLowerCase(), t = $(".page-sidebar-menu");
        if ("click" === e || "set" === e ? a = $(a) : "match" === e && t.find("li > a").each(function () {
            ...
            t.find("li.active").removeClass("active"), t.find("li > a > .selected").remove(), t.hasClass("page-sidebar-menu-hover-submenu") === !1 ? t.find("li.open").each(function () {
                0 === $(this).children(".sub-menu").size() && ($(this).removeClass("open"), $(this).find("> a > .arrow.open").removeClass("open"))
            }) : t.find("li.open").removeClass("open"), a.parents("li").each(function () {
        ...
        $(".page-sidebar").on("click", "li > a", function (e) {
            if (!(App.getViewPort().width >= s && 1 === $(this).parents(".page-sidebar-menu-hover-submenu").size())) {
                ...
                if (!$(this).next().hasClass("sub-menu always-open")) {
                    var a = $(this).parent().parent(), t = $(this), o = $(".page-sidebar-menu"), n = $(this).next(), r = o.data("auto-scroll"), p = parseInt(o.data("slide-speed")), d = o.data("keep-expanded");
                    ...
                    n.is(":visible") ? ($(".arrow", $(this)).removeClass("open"), $(this).parent().removeClass("open"), n.slideUp(p, function () {
                        r === !0 && $("body").hasClass("page-sidebar-closed") === !1 && ($("body").hasClass("page-sidebar-fixed") ? o.slimScroll({scrollTo: t.position().top}) : App.scrollTo(t, l)), i()
            ...
            var a = $(this).attr("href"), i = $(".page-sidebar ul"), t = ($(".page-content"), $(".page-content .page-content-body"));
        ...
        $.cookie && "1" === $.cookie("sidebar_closed") && App.getViewPort().width >= s && ($("body").addClass("page-sidebar-closed"), $(".page-sidebar-menu").addClass("page-sidebar-menu-closed")), $("body").on("click", ".sidebar-toggler", function (a) {
            var s = $(".page-sidebar"), i = $(".page-sidebar-menu");
