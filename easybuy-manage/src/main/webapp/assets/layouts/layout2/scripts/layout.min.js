var Layout = function () {
    var e = "layouts/layout2/img/", a = "layouts/layout2/css/", t = App.getResponsiveBreakpoint("md"), i = function () {
        ...
        if (s.hasClass("page-footer-fixed") === !0 && s.hasClass("page-sidebar-fixed") === !1) {
            ...
            if (s.hasClass("page-sidebar-fixed"))e = r(), s.hasClass("page-footer-fixed") === !1 && (e -= $(".page-footer").outerHeight()); else {
                var n = $(".page-header").outerHeight(), p = $(".page-footer").outerHeight();
                e = App.getViewPort().width < t ? App.getViewPort().height - n - p : i.height() + 20, e + n + p <= App.getViewPort().height && (e = App.getViewPort().height - n - p)
            }
            ...
            if (!(App.getViewPort().width >= t && !$(".page-sidebar-menu").attr("data-initialized") && $("body").hasClass("page-sidebar-closed") && 1 === a.parent("li").parent(".page-sidebar-menu").size())) {
                ...
                if (!(App.getViewPort().width >= t && 1 === a.parents(".page-sidebar-menu-hover-submenu").size())) {
                    ...
                    if (!a.next().hasClass("sub-menu always-open")) {
                        var o = a.parent().parent(), n = a, r = $(".page-sidebar-menu"), p = a.next(), d = r.data("auto-scroll"), l = parseInt(r.data("slide-speed")), c = r.data("keep-expanded");
                        c !== !0 && (o.children("li.open").children("a").children(".arrow").removeClass("open"), o.children("li.open").children(".sub-menu:not(.always-open)").slideUp(l), o.children("li.open").removeClass("open"));
                        var h = -200;
                        p.is(":visible") ? ($(".arrow", n).removeClass("open"), n.parent().removeClass("open"), p.slideUp(l, function () {
        ...
        return App.destroySlimScroll(e), 0 === $(".page-sidebar-fixed").size() ? void i() : void(App.getViewPort().width >= t && (e.attr("data-height", r()), App.initSlimScroll(e), i()))
    }, d = function () {
        var e = $("body");
