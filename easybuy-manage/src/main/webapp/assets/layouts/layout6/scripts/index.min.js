var Index = function () {
    var e = function () {
        ...
        var e = AmCharts.makeChart("animated-pie-chart", {
            type: "pie",
            theme: "light",
            path: "../../assets/global/plugins/amcharts/ammap/images/",
        ...
        jQuery(".chart-input").off().on("input change", function () {
            var a = jQuery(this).data("property"), t = e, i = Number(this.value);
            e.startDuration = 0, "innerRadius" == a && (i += "%"), t[a] = i, e.validateNow()
        })
    }, t = function () {
