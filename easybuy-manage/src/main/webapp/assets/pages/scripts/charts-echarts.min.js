jQuery(document).ready(function () {
    require.config({paths: {echarts: "../assets/global/plugins/echarts/"}}), require(["echarts", "echarts/chart/bar", "echarts/chart/chord", "echarts/chart/eventRiver", "echarts/chart/force", "echarts/chart/funnel", "echarts/chart/gauge", "echarts/chart/heatmap", "echarts/chart/k", "echarts/chart/line", "echarts/chart/map", "echarts/chart/pie", "echarts/chart/radar", "echarts/chart/scatter", "echarts/chart/tree", "echarts/chart/treemap", "echarts/chart/venn", "echarts/chart/wordCloud"], function (e) {
        ...
        a.setOption({
            ...
            }, {name: "Expenses", type: "bar", data: [2.6, 5.9, 9, 26.4, 28.7, 70.7, 175.6, 182.2, 48.7, 18.8, 6, 2.3]}]
        });
        var t = e.init(document.getElementById("echarts_line"));
        t.setOption({
            title: {text: "Weekly Weather", subtext: "Lorem ipsum"},
            tooltip: {trigger: "axis"},
            ...
            series: [{
                ...
                type: "line",
                data: [1, -2, 2, 5, 3, 2, 0],
                markPoint: {data: [{name: "Lowest", value: -2, xAxis: 1, yAxis: -1.5}]},
                markLine: {data: [{type: "average", name: "Mean"}]}
            }]
        });
        ...
        r.setOption({
            ...
            yAxis: [{type: "value", position: "right", scale: !0}],
            animation: !1,
            series: [{
                name: "scatter1", type: "scatter", symbolSize: 5, data: function () {
        ...
        o.setOption({
            ...
            series: [{
                ...
                itemStyle: {
                    ...
                    }, emphasis: {color: "black", color0: "white"}
                },
                data: [{
                    value: [2320.26, 2302.6, 2287.3, 2362.94],
                    itemStyle: {
                        normal: {color0: "blue", lineStyle: {width: 3, color0: "blue"}},
                ...
                markPoint: {
                    ...
                    data: [{name: "Highest", value: 2444.8, xAxis: "2013/2/18", yAxis: 2466}]
                }
            }]
        });
        ...
        l.setOption({
            ...
            series: [{
                ...
                itemStyle: {
                    normal: {
                        label: {
                            position: "inner", formatter: function (e) {
                                return (e.percent - 0).toFixed(0) + "%"
                            }
                        }, labelLine: {show: !1}
                    }, emphasis: {label: {show: !0, formatter: "{b}\n{d}%"}}
                },
                data: [{value: 335, name: "All"}, {value: 679, name: "Marketing"}, {value: 1548, name: "Search"}]
            }, {
                name: "Source",
                type: "pie",
                center: ["35%", 200],
                radius: [110, 140],
                data: [{value: 335, name: "All"}, {value: 310, name: "EDM"}, {
                    value: 234,
                    name: "Partnership"
                }, {value: 135, name: "Video"}, {
                    value: 1048, name: "Social", itemStyle: {
                        normal: {
                            color: function () {
                            ...
                            labelLine: {length: 40, lineStyle: {color: "#f0f", width: 3, type: "dotted"}}
                        }
                    }
                    ...
                    itemStyle: {
                        ...
                        emphasis: {label: {show: !0}, labelLine: {show: !0, length: 50}}
                    }
                }, {value: 147, name: "Others"}]
            }, {
                name: "Source",
                type: "pie",
                clockWise: !0,
                ...
                radius: [80, 120],
                itemStyle: {
                    normal: {label: {show: !1}, labelLine: {show: !1}}, emphasis: {
                        color: function () {
                            var e = require("zrender/tool/color");
                        ...
                        label: {
                            ...
                            position: "center",
                            formatter: "{d}%",
                            textStyle: {color: "red", fontSize: "30", fontFamily: "Open Sans", fontWeight: "bold"}
                        }
                    }
                },
                data: [{value: 335, name: "All"}, {value: 310, name: "EDM"}, {
                    value: 234,
                    name: "Partnership"
                }, {value: 135, name: "Video"}, {value: 1548, name: "Search"}],
