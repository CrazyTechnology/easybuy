var MapsGoogle = function () {
    var o = function () {
        new GMaps({div: "#gmap_basic", lat: -12.043333, lng: -77.028333})
    }, t = function () {
        var o = new GMaps({div: "#gmap_marker", lat: -51.38739, lng: -6.187181});
        o.addMarker({
            lat: -51.38739,
            lng: -6.187181,
            title: "Lima",
        ...
        var o = new GMaps({div: "#gmap_geo", lat: -12.043333, lng: -77.028333});
        GMaps.geolocate({
            success: function (t) {
        ...
        var o = new GMaps({div: "#gmap_geocoding", lat: -12.043333, lng: -77.028333}), t = function () {
        ...
        var o = new GMaps({
            ...
            lat: -12.043333,
            lng: -77.028333
        }), t = [[-12.040397656836609, -77.03373871559225], [-12.040248585302038, -77.03993927003302], [-12.050047116528843, -77.02448169303511], [-12.044804866577001, -77.02154422636042]];
        o.drawPolygon({
            paths: t,
            strokeColor: "#BBD8E9",
            strokeOpacity: 1,
        ...
        var o = new GMaps({div: "#gmap_routes", lat: -12.043333, lng: -77.028333});
        $("#gmap_routes_start").click(function (t) {
            t.preventDefault(), App.scrollTo($(this), 400), o.travelRoute({
                origin: [-12.044012922866312, -77.02470665341184],
                destination: [-12.090814532191756, -77.02271108990476],
                travelMode: "driving",
                step: function (t) {
                    $("#gmap_routes_instructions").append("<li>" + t.instructions + "</li>"), $("#gmap_routes_instructions li:eq(" + t.step_number + ")").delay(800 * t.step_number).fadeIn(500, function () {
