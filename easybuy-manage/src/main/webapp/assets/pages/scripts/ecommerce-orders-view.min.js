var EcommerceOrdersView = function () {
    var e = function () {
        ...
        e.init({
            ...
            dataTable: {
                lengthMenu: [[10, 20, 50, 100, 150, -1], [19, 20, 50, 100, 150, "All"]],
                pageLength: 10,
                ajax: {url: "../demo/ecommerce_order_invoices.php"},
                order: [[1, "asc"]]
            }
        ...
        e.init({
            ...
            dataTable: {
                ...
                pageLength: 10,
                ajax: {url: "../demo/ecommerce_order_credit_memos.php"},
        ...
        e.init({
            ...
            dataTable: {
                lengthMenu: [[10, 20, 50, 100, 150, -1], [10, 20, 50, 100, 150, "All"]],
                pageLength: 10,
                ajax: {url: "../demo/ecommerce_order_shipment.php"},
                columnDefs: [{orderable: !0, targets: [0]}],
                order: [[0, "asc"]]
            }
        })
        ...
        e.init({
            ...
            dataTable: {
                lengthMenu: [[10, 20, 50, 100, 150, -1], [10, 20, 50, 100, 150, "All"]],
                pageLength: 10,
                ajax: {url: "../demo/ecommerce_order_history.php"},
                columnDefs: [{orderable: !0, targets: [0]}],
                order: [[0, "asc"]]
            }
        }), e.getTableWrapper().on("click", ".table-group-action-submit", function (a) {
